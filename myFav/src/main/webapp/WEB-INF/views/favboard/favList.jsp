...
<div class="alert alert-success">
  <c:choose>
    ...
    <c:otherwise>
        <strong>${nowgroupname} 즐겨찾기 그룹입니다. ${groupcount} 개의 목록이 있습니다. </strong>
      ...
      <tr>
		...
		<td>
		  <div style="height: 20px; overflow:hidden;">
		      <a href="favRead${pageMaker.makeQuery(pageMaker.cri.page)}&favnum=${urlList.favnum}&searchType=${cri.searchType}&keyword=${cri.keyword}&groupnum=${cri.groupnum}">${urlList.memo}</a>
		  </div>
		</td>
<%-- 		<td>
